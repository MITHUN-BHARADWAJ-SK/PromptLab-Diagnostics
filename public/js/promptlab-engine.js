...
const DIMENSIONS = {
    clarity: {
        label: 'Clarity',
        description: 'How clear and unambiguous the prompt language is.',
        maxScore: 5,
    },
    constraintCompleteness: {
        label: 'Constraint Completeness',
        description: 'Whether the prompt specifies format, length, style, audience, and tone.',
        maxScore: 5,
    },
    modelAlignment: {
        label: 'Model Alignment',
        description: 'How well the prompt leverages the target model\'s strengths.',
        maxScore: 5,
    },
    ambiguityRisk: {
        label: 'Ambiguity Risk',
        description: 'The likelihood of the prompt being misinterpreted.',
        maxScore: 5,
    },
    outputControllability: {
        label: 'Output Controllability',
        description: 'How much control the user has over the shape and content of the output.',
        maxScore: 5,
    },
};
...
const MODEL_WEIGHTS = {
    openai: {
        // GPT excels at instruction following + structured output.
        // Output controllability & clarity matter most.
        clarity: 0.25,
        constraint_completeness: 0.20,
        ambiguity_risk: 0.15,
        output_controllability: 0.30,
        model_alignment: 0.10,
    },
    anthropic: {
        // Claude is safety-focused; constraints & boundaries keep it on task.
        // Constraint completeness & ambiguity risk matter most.
        clarity: 0.20,
        constraint_completeness: 0.30,
        ambiguity_risk: 0.25,
        output_controllability: 0.15,
        model_alignment: 0.10,
    },
    gemini: {
        // Gemini is multimodal + context-hungry; model alignment & clarity matter most.
        clarity: 0.25,
        constraint_completeness: 0.15,
        ambiguity_risk: 0.15,
        output_controllability: 0.20,
...
const MODEL_OUTPUT_SECTIONS = {
    openai: {
        dimensionOrder: ['output_controllability', 'clarity', 'constraint_completeness', 'ambiguity_risk', 'model_alignment'],
    ...
    anthropic: {
        dimensionOrder: ['constraint_completeness', 'ambiguity_risk', 'clarity', 'output_controllability', 'model_alignment'],
        showPromptRewriteHint: true,
    ...
    gemini: {
        dimensionOrder: ['model_alignment', 'clarity', 'output_controllability', 'constraint_completeness', 'ambiguity_risk'],
        showPromptRewriteHint: true,
